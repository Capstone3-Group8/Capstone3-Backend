  ...
  try {
    ...
    await Task.bulkCreate([
      ...
      },
      {
        ...
        description: "Run createdb capstone_dev",
        completed: true,
      },
      {
        title: "Build my first model",
        description: "Copy the Task model as a reference",
        completed: false,
      },
      {
        title: "Write my first route",
        description: "Add a CRUD router under /api",
        completed: false,
      },
    ]);
